        ...
        <main className="max-w-4xl mx-auto px-6 py-20 text-center">
          <div className="bg-slate-800/50 rounded-2xl p-12 border border-slate-700/50">
            ...
            <p className="text-slate-400 mb-8 text-lg">
              Please sign in with your Google account to remove image backgrounds
            </p>
            <button
              onClick={() => signIn('google')}
              className="px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-medium rounded-xl transition-colors inline-flex items-center gap-3 text-lg"
            >
